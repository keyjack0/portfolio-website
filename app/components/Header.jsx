        ...
        <div className='flex flex-col items-center justify-center w-11/12 h-screen max-w-3xl gap-4 mx-auto text-center pt-20'>
            <div>
                ...
                <div className='flex flex-col items-center gap-4 mt-4 sm:flex-row'>
                    <a href="#contact" 
                    className='flex items-center gap-2 px-10 py-3 text-white bg-black border border-white rounded-full'>Contact me <Image src={assets.right_arrow_white} alt='' className='w-4' /></a>

                    <a href="#"
                    download className='flex items-center gap-2 px-10 py-3 border border-gray-500 rounded-full'>My resume <Image src={assets.download_icon} alt='' className='w-4' /></a>
                </div>
            {/* </div> */}
        </div>
    )
